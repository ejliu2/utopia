...
/*-----------------------------------------------
              @(target):= _utopia_grid.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__utopia_grid

#else
#  define SWIG_init    init_utopia_grid

#endif
#define SWIG_name    "_utopia_grid"
...
SWIGINTERN PyObject *_wrap_initialize(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "initialize", 2, 2, swig_obj)) SWIG_fail;
